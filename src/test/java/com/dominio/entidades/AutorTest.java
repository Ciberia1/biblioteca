...
class AutorTest {
	...
	private Autor autor;
	private static Set<Libro> libro = new HashSet<>();
	...
	@Test
	public final void testAutor() throws Exception {
	...
	@Test
	public final void testSetid() throws Exception {
		long id = (long) 30;
		autor.setId(id);
	...
	@Test
	public final void testGetapellido() throws Exception {
		assertEquals("García", autor.getApellido());
	}
	
	@Test
	public final void testSetapellido() throws Exception {
	...
	@Test
	public final void testGetBiografia() throws Exception {
		assertEquals("Su obra más famosa es la colmena", autor.getBiografia());
	}
	
	@Test
	public final void testSetBiografia() throws Exception {
	...
	@Test
	public final void testGetlibros() throws Exception {
	...
	@Test
	public final void testSetlibros() throws Exception {
