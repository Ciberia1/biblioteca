...
/**
 * La función "altaAutor" guarda un nuevo autor en la base de datos y redirige a la página
 * "gestionAutor".
 * 
 * @param autor El parámetro "autor" es un objeto de la clase "Autor" que se pasa como atributo del
 * modelo en la solicitud.
...
/**
 * La función "editarAutorObra" en el código Java se utiliza para editar los autores de un libro
 * recibiendo el ID del libro y una lista de ID de autores como parámetros.
 * 
 * @param libroId El parámetro libroId es una Cadena que representa el ID de un libro que necesita ser
 * editado.
...
/**
 * La función actualiza una lista de autores en una base de datos y redirige a una página de
 * administración.
 * 
 * @param autores Una lista de objetos de Autor que se actualizarán en la base de datos.
 * @return El método devuelve una cadena "redirect:/gestionAutor".
 */
 ...
 * 
 * @param autoresIds Una lista de valores largos que representan los ID de los autores que se
 * eliminarán.
 * @return El método devuelve una cadena "redirect:/gestionAutor".
 */
