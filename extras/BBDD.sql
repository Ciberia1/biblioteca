...
VALUES ('55154299T', '2022-12-31', 'Usuario', 'José', 'Pérez', 5, '1234'),
       ('46402330Z', '2022-12-31', 'Usuario', 'María', 'Gómez', 6, '1234'),
       ('55787970K', '2022-12-31', 'Usuario', 'Antonio', 'López', 6, '1234'),
       ('79168195X', '2022-12-31', 'Usuario', 'Carmen', 'Sánchez', 6, '1234'),
...
VALUES ('2022-12-01', '55154299T', 1000001, 1000001),
       ('2022-12-02', '46402330Z', 1000002, 1000002),
       ('2022-12-03', '55787970K', 1000003, 1000003),
       ('2022-12-04', '79168195X', 1000004, 1000004);
	
INSERT INTO DERBYUSER.PRESTAMO(Fecha_Inicio_Pres, Fecha_Fin_Pres, Activo, DNI, EJEMPLARID, ID)
VALUES ('2022-11-01', '2022-11-30', true, '46402330Z', 1000001, 1000001), 
       ('2022-11-02', '2022-11-30', true, '55154299T', 1000002, 1000002), 
       ('2023-01-01', '2023-01-31', false, '23456789A', 1000003, 1000003), 
       ('2023-02-01', '2023-02-28', true, '79168195X', 1000004, 1000004);